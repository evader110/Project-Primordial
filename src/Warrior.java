...
{	
	...
	private final int PATROL_DISTANCE = 100;
	...
	public void decideBehavior()
	{
		...
		{	
			...
			{
				if(battalionCount < maxBattalionCount)
				{
					moveTowards(queen);
					health = MAX_HEALTH + 5;
					maxBattalionCount += 5;
					battalionCount = maxBattalionCount;
				}
				else if(hasFood)				
